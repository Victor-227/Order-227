...
NGame = {
	...
	GAME_SPEED_SECONDS = { 600.0, 0.5, 0.2, 0.1, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NDiplomacy = {
	...
	BASE_SEND_ATTACHE_COST = 150,					-- Political power cost to send attache
...
NCountry = {
	...
	SPECIAL_FORCES_CAP_MIN = 10000,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NProduction = {
	...
	MIN_FIELD_TO_TRAINING_MANPOWER_RATIO = 100.0,	-- Ratio which % of army in field can be trained
	...
	LICENSE_EQUIPMENT_UPGRADE_XP_FACTOR = 0,			-- XP cost for upgrading licensed equipment
...
NMilitary = {
	...
	MAX_LEADERS_TO_SHOW = 0,							--Max officers to show in field officers list, sorted by field EXP. Divisions with awardable entries will potentially supercede this limit
